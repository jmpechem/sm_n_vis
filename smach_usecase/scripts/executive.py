...
class Door_Init(smach.State):
	def __init__(self):
	    smach.State.__init__(self,outcomes=['d_ready','cmd_modechg','loop','shutdown'])

	def execute(self,userdata):
	    trans_tag = rospy.wait_for_message('transition',String)
	    if trans_tag.data == "d_ready":
		return 'd_ready'
	    elif trans_tag.data == "cmd_modechg":
		return 'cmd_modechg'
	    elif trans_tag.data == "shutdown":
...
class Door_Ready(smach.State):
	def __init__(self):
	    smach.State.__init__(self,outcomes=['d_reach','cmd_modechg','loop','shutdown'])

	def execute(self,userdata):
 	    trans_tag = rospy.wait_for_message('transition',String)
	    if trans_tag.data == "d_reach":
		return 'd_reach'
	    elif trans_tag.data == "cmd_modechg":
		return 'cmd_modechg'
	    elif trans_tag.data == "shutdown":
...
class Door_Reach(smach.State):
	def __init__(self):
	    smach.State.__init__(self,outcomes=['d_open','cmd_modechg','loop','shutdown'])

	def execute(self,userdata):
	    trans_tag = rospy.wait_for_message('transition',String)
	    if trans_tag.data == "d_open":
		return 'd_open'
	    elif trans_tag.data == "cmd_modechg":
		return 'cmd_modechg'
	    elif trans_tag.data == "shutdown":
...
class Door_Open(smach.State):
	def __init__(self):
	    smach.State.__init__(self,outcomes=['d_push','cmd_modechg','loop','shutdown'])

	def execute(self,userdata):
	    trans_tag = rospy.wait_for_message('transition',String)
	    if trans_tag.data == "d_push":
		return 'd_push'
	    elif trans_tag.data == "cmd_modechg":
		return 'cmd_modechg'
	    elif trans_tag.data == "shutdown":
...
#    rospy.Subscriber("/transition",String,cb)
	...
	#Door_Init state
	smach.StateMachine.add('Door_Init',Door_Init(),transitions={'d_ready':'Door_Ready','cmd_modechg':'Mode_Chg','loop':'Door_Init','shutdown':'END'})
	#Door_Ready state
	smach.StateMachine.add('Door_Ready',Door_Ready(),transitions={'d_reach':'Door_Reach','cmd_modechg':'Mode_Chg','loop':'Door_Ready','shutdown':'END'})
	#Door_Reach state
	smach.StateMachine.add('Door_Reach',Door_Reach(),transitions={'d_open':'Door_Open','cmd_modechg':'Mode_Chg','loop':'Door_Reach','shutdown':'END'})
	#Door_Open state
	smach.StateMachine.add('Door_Open',Door_Open(),transitions={'d_push':'Door_Push','cmd_modechg':'Mode_Chg','loop':'Door_Open','shutdown':'END'})
	#Door_Push state
