...
class Event(Simple_State):
  def __init__(self):
    smach.State.__init__(self, outcomes=['handclap','handshake','cmd_modechg','shutdown'])
...
#    rospy.Subscriber("/transition",String,cb)
  ...
  with sm_top:
    ...
    smach.StateMachine.add('Event',Event(),
                          transitions={'handclap':'Handclap_Start','handshake':'Handshake_Start', 'cmd_modechg':'Mode_Chg','shutdown':'END'})
    # JointCtrl state
